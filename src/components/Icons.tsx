...
export const YouTubeMusicIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="m88,46c-23.1,0-42,18.8-42,42s18.8,42,42,42,42-18.8,42-42-18.9-42-42-42Zm-16,65v-46l39,22-39,24Z" />
      <path d="m88,0C39.4,0,0,39.4,0,88s39.4,88,88,88,88-39.4,88-88S136.6,0,88,0Zm0,134c-25.4,0-46-20.6-46-46s20.6-46,46-46,46,20.6,46,46-20.6,46-46,46Z" />
    </svg>
  );
};
